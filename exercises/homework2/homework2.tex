...
Solutions to this exercise sheet are to be handed in
 before the lecture on Friday, XY.XY.12. Code (.m-file) and output (.mat-file, figures as .pdf-files) for the  matlab-questions should be either submitted by email to \texttt{XY@student.uni-tuebingen.de} (subject: [ML1] Exercise 3) or uploaded to Ilias. Use comments to explain your code. Please adhere to the file naming convention: \texttt{Homework3\_<YourName>.<ext>}.}}}
\end{center}
\vspace{.5cm}
